  ...
  return (
    <div>
      <div className="mb-5 flex items-center justify-between">
        ...
        <span className="font-condensed inline-flex items-center gap-1.5 border border-border bg-surface px-3 py-1.5 text-xs font-bold uppercase tracking-widest text-muted-foreground">
          <Inbox className="h-3.5 w-3.5" /> {items.length} pendientes
        </span>
      </div>
