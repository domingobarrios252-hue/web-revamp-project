...
export const Route = createFileRoute("/hub/$country/competicion/liga-nacional/calendario")({
  component: CalendarioLigaPage,
});

function CalendarioLigaPage() {
    ...
    <div className="mx-auto max-w-7xl px-4 md:px-6 py-8">
      <div className="flex flex-wrap items-end justify-between gap-4 mb-6">
        <div>
          ...
          <h2 className="mt-1 font-display text-2xl md:text-3xl font-black text-[#F5F5F5]">Calendario oficial</h2>
          <p className="mt-1 text-sm text-[#888]">Cada jornada con fecha, sede, mapa, cartel y estado en vivo.</p>
        </div>
        {seasons.length > 0 && (
