...
export const Route = createFileRoute("/$country/galeria")({ component: Page });
...
function Page() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 md:px-6 text-center">
      <h1 className="font-display text-3xl tracking-widest">Galería <span className="text-gold">{c.name}</span></h1>
