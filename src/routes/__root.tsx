...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "La página oficial de Rollerzone para las noticias del patinaje de velocidad nacional e internacional." },
...
function RootShell({ children }: { children: React.ReactNode }) {
  return (
    <html lang="es" className="overflow-x-clip">
      ...
      <body className="premium-noise-bg overflow-x-clip">
        {children}
        <Scripts />
      </body>
    </html>
