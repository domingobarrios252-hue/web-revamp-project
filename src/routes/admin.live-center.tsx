...
const EDITABLE_COPY_FIELDS: Array<{ key: keyof HomeSetting; label: string; placeholder: string }> = [
  ...
  { key: "laps_title", label: "Título vueltas", placeholder: "Tiempos por vuelta" }, { key: "head_title", label: "Título head-to-head", placeholder: "Análisis Head-to-Head" }, { key: "head_button_label", label: "Botón head-to-head", placeholder: "Elegir patinadores" }, { key: "notifications_title", label: "Título alertas", placeholder: "Notificaciones Live Center" },
