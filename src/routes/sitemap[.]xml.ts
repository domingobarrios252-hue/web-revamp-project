...
const STATIC_ENTRIES: SitemapEntry[] = [
  ...
  { path: "/miami", changefreq: "daily", priority: "0.8" },
  { path: "/miami/noticias", changefreq: "daily", priority: "0.7" },
  { path: "/miami/entrevistas", changefreq: "weekly", priority: "0.6" },
  { path: "/portugal", changefreq: "daily", priority: "0.8" },
  { path: "/portugal/noticias", changefreq: "daily", priority: "0.7" },
  { path: "/portugal/entrevistas", changefreq: "weekly", priority: "0.6" },
  { path: "/hub/co/competicion", changefreq: "weekly", priority: "0.6" },
  { path: "/camino-al-europeo-2026", changefreq: "weekly", priority: "0.7" },
  { path: "/liga-nacional/clasificaciones", changefreq: "weekly", priority: "0.8" },
  { path: "/espana/federaciones", changefreq: "monthly", priority: "0.6" },
  { path: "/especiales", changefreq: "weekly", priority: "0.6" },
  { path: "/colaboraciones", changefreq: "monthly", priority: "0.5" },
  { path: "/equipo", changefreq: "monthly", priority: "0.4" },
  { path: "/hub/pt", changefreq: "daily", priority: "0.7" },
