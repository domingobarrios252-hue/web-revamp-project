...
export const AD_PLACEMENTS: PlacementDef[] = [
  ...
  { group: "Eventos", value: "eventos_detail", label: "Eventos (detalle) — lateral (300×100)" },
  { group: "Revista", value: "revista_side", label: "Revista — lateral / destacado (300×100)" },
  { group: "Hub España", value: "hub_espana_top", label: "Hub España — cabecera" },
  { group: "Hub España", value: "hub_espana_side", label: "Hub España — lateral (300×100)" },
  { group: "Hub Colombia", value: "hub_colombia_top", label: "Hub Colombia — cabecera" },
  { group: "Hub Colombia", value: "hub_colombia_side", label: "Hub Colombia — lateral (300×100)" },
  { group: "Live", value: "live_top", label: "Live Center — cabecera" },
  { group: "Live", value: "live_side", label: "Live Center — lateral (300×100)" },
  { group: "MVP", value: "mvp_side", label: "Premios MVP — lateral (300×100)" },
  { group: "Directorios", value: "clubes_side", label: "Clubes (listado) — lateral (300×100)" },
  { group: "Directorios", value: "clubes_detail", label: "Club (ficha) — lateral (300×100)" },
  { group: "Directorios", value: "patinadores_side", label: "Patinadores (listado) — lateral (300×100)" },
  { group: "Directorios", value: "patinadores_detail", label: "Patinador (ficha) — lateral (300×100)" },
  { group: "Directorios", value: "federaciones_side", label: "Federaciones — lateral (300×100)" },
  { group: "Directorios", value: "entrevistas_side", label: "Entrevistas — lateral (300×100)" },
  { group: "Directorios", value: "salon_fama_side", label: "Salón de la Fama — lateral (300×100)" },
  { group: "Directorios", value: "resultados_side", label: "Resultados — lateral (300×100)" },
